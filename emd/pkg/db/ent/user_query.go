...
func (uq *UserQuery) loadTasks(ctx context.Context, query *TaskQuery, nodes []*User, init func(*User), assign func(*User, *Task)) error {
	...
	query.Where(func(s *sql.Selector) {
		joinT := sql.Table(user.TasksTable)
		s.Join(joinT).On(s.C(task.FieldID), joinT.C(user.TasksPrimaryKey[1]))
		s.Where(sql.InValues(joinT.C(user.TasksPrimaryKey[0]), edgeIDs...))
		columns := s.SelectedColumns()
		s.Select(joinT.C(user.TasksPrimaryKey[0]))
